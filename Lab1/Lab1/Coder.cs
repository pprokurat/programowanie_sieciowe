...
namespace Lab1
{
    class Coder
    {
        ...
        public void CodeText()
        {
            try
            {
                ...
                for (i = 0; i < arraySize6; i++)
                {
                    ...
                    if (i == arraySize6 - 1 && (padSize == 1 || padSize ==2))
                    {
                        byteArray[i] = 64;
                    }

                    if (i == arraySize6 - 2 && padSize == 2)
                    {
                        byteArray[i] = 64;
                    }                    
                }
        ...
        public void ReadBmp()
        {
            try
            {
                Image image = Image.FromFile(@"test1c.bmp");
                ...
                for (i = 0; i < bmpBytes.Length; i++)
                {
                    //byte b = Convert.ToByte(bmpBytes[i]);
                    byte b = bmpBytes[i];
                    if (b > 127)
                    {
                ...
                //podział kodu binarnego na grupy 6-bitowe
                int arraySize6 = (bmp_bin.Length / 6) + 1;
                String[] text6groups = new String[arraySize6];
                i = 0;
                ...
                for (i = 0; i < arraySize6; i++)
                {
                    bmp_pad1 += text6groups[i];
                    Console.Write(text6groups[i] + " ");
                }
                }

                Console.WriteLine();
                //Console.WriteLine(bmp_pad1);

                int padSize = 0;
                if (bmp_pad1.Length % 24 >= 12)
                {
                    int k = bmp_pad1.Length % 24;
                ...
                //ponowny podział na grupy 6-bitowe
                arraySize6 = (bmp_pad1.Length / 6) + 1;
                text6groups = new String[arraySize6];
                i = 0;
                foreach (char c in bmp_pad1)
                {
                    text6groups[i] += c;
